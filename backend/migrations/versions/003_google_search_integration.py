...
def upgrade() -> None:
    ...
    op.create_table('search_queries',
        ...
        sa.Column('total_results_found', sa.BIGINT(), nullable=True, server_default='0'),
        sa.Column('results_retrieved', sa.INTEGER(), nullable=True, server_default='0'),
        sa.Column('search_time_ms', sa.INTEGER(), nullable=True, server_default='0'),
        sa.Column('api_quota_cost', sa.INTEGER(), nullable=True, server_default='1'),
